...
const privacyStatement = {
  ...
  bifrost:
    "When offering our services, we may gather the information that can be found publicly on a blockchain. This information includes the public wallet identifier involved in a transaction, a unique identifier for the transaction, the value of the transaction as well as related fees, and the status of the transaction, such as if it has been completed, is still in progress or resulted in an error.",
};
    ...
    rpcs: [
      {
        ...
        tracking: "yes",
        trackingDetails: privacyStatement.bifrost,
      },
      {
        url: "https://public-02.mainnet.thebifrost.io/rpc",
        tracking: "yes",
        trackingDetails: privacyStatement.bifrost,
      },
    ],
