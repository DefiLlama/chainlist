...
const privacyStatement = {
  ...
  reliableninjas:
    "Reliable Ninjas does not collect or track personal user information. The only data temporarily logged is your IP address for the sole purpose of rate limiting RPC usage. These logs are cleared weekly. No other identifiable or sensitive information is collected or stored. Reliable Ninjas does not use cookies or tracking technologies. We do not sell, share, or disclose user data to third parties. For more information, please visit: https://reliableninjas.com/privacy-policy"
};
